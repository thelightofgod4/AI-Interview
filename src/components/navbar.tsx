...
function Navbar() {
  ...
  return (
    <div className="fixed inset-x-0 top-0 bg-slate-100 z-[10] min-h-[64px] py-4 safe-top">
      <div className="flex items-center justify-between h-full gap-2 px-4 md:px-8 mx-auto max-w-7xl min-h-[56px]">
